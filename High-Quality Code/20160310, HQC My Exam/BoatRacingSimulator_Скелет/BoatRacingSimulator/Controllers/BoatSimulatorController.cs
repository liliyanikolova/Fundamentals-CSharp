namespace BoatRacingSimulator.Controllers
{
    ...
    using BoatRacingSimulator.Models.BoatModels;
    using BoatRacingSimulator.Models.BoatModels.MotorBoats;
    using BoatRacingSimulator.Models.EngineModels;
    ...
    public class BoatSimulatorController : IBoatSimulatorController
    {
        ...
        public BoatSimulatorController() : this(new BoatSimulatorDatabase())
        {
        }
        ...
        public string SignUpBoat(string model)
        {
            ...
            if (!this.CurrentRace.AllowsMotorboats && boat is MotorBoats)
            {
        ...
        private KeyValuePair<double, IBoat> FindFastest(IList<IBoat> participants)
        {
            ...
            if (winner == null)
            {
                ...
                var speed = winner.CalculateRaceSpeed(this.CurrentRace);
                bestTime = this.CurrentRace.Distance / speed;
            }
